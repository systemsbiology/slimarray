...
describe ChipPurchasesController do
  ...
  describe "responding to POST create" do
    ...
    before(:each) do
      ChipPurchase.should_receive(:new).with("params").and_return(@mock_chip_purchase)
    end

    def do_post
      post :create, :lab_group_id => 42, :chip_type_id => 23, :chip_purchase => "params"
    end
    ...
    context "with a failed save" do
      ...
      before(:each) do
        @mock_chip_purchase.should_receive(:valid?).and_return(false)
      end
