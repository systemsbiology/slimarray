...
== Edit your application configuration

Edit /apps/slimarray/config/application.yml to specify the location of your RubyCAS 
server and SLIMcore (only necessary if you're using SLIMcore Authorizer), and your API username 
and password.

== Run the setup task

Running the setup task will install the necessary plugins and gems, initialize the database and 
create and administrator user. This needs to be run using sudo since it will be installing some gems.
